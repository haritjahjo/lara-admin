        ...
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            ...
            <table class="min-w-full divide-y divide-gray-300">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-3 py-3 text-left text-xs font-medium uppercase tracking-wide text-gray-500">Published</th>
                    <th scope="col" class="px-3 py-3 text-left text-xs font-medium uppercase tracking-wide text-gray-500">Image</th>
