    ...
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          ...
          <p class="mt-2 text-sm text-gray-700">A list of all the tags in your account including their name, title, email and role.</p>
        </div>
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
          <form action="{{ route('tags.create')}}" method="get">
          @csrf
          <button :href="route('tags.create')"
                  ...
                  <x-card class="bg-green-500">
                    ...
                    <tr>
                      ...
                      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <a href="{{ route('tags.edit', $tag->id )}}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                        <a href="{{ route('tags.show', $tag->id )}}" class="text-indigo-600 hover:text-indigo-900">Show</a>
